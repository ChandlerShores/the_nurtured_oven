...
export default function FeaturedProduct({
  ...
  const eyebrow = product.featuredEyebrow ?? "This Week's Feature"

  return (
    <div
      id="this-weeks-feature"
      className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 pb-12 scroll-mt-24"
    >
      <div className="menu-feature-card bg-warm-white rounded-[1.75rem] border border-linen/40 shadow-warm overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-10">
          ...
          <div className="p-8 sm:p-10 lg:pl-2 lg:pr-12 flex flex-col justify-center">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl text-espresso tracking-wide mb-3">
              {product.name}
            </h2>
