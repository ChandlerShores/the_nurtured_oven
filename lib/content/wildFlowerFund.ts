export const wildFlowerFund = {
  name: "The Wild Flower Fund",
  path: "/wild-flower-fund",
  tagline: "Moms caring for moms. Comfort beyond the box.",
  percentLabel: "10%",

  bannerImage:
    "https://images.unsplash.com/photo-1755335492033-40fa483de12b?w=1920&q=80&auto=format&fit=crop",
  bannerImageAlt:
    "Soft wildflowers in warm light",
  ...
  openingLine:
    "Because some seasons of motherhood need a little more grace.",

  pullQuote:
    "A warm meal on a doorstep, a box that says someone sees you. One mom showing up for another can mean everything during the hardest weeks.",
