export const playbook = {
  ...
  weekRhythm: [
    ...
    { day: "Sat–Wed noon", customer: "Order from this week's menu", you: "Prep & bake" },
  ...
  coreCta:
    "Order by Wednesday at noon — free Friday pickup or Georgetown/Lexington delivery ($7, free $40+).",
