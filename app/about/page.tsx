    ...
    <div className="bg-cream">
        ...
        <div className="max-w-3xl mx-auto px-5 sm:px-8 py-16 sm:py-20">
          ...
          <div className="space-y-5">
            {founder.fullStory.map((paragraph, i) => (
              <p
                key={i}
                className="text-muted text-lg leading-relaxed font-body"
              >
                {paragraph}
              </p>
            ))}
      ...
      <div className="bg-oatmeal/40">
        <div className="max-w-3xl mx-auto px-5 sm:px-8 py-16 sm:py-20 text-center">
          <p className="font-accent text-eyebrow text-lg mb-2">come say hello</p>
      ...
      <div className="max-w-3xl mx-auto px-5 sm:px-8 py-10">
        <p className="text-hint text-xs leading-relaxed text-center">
