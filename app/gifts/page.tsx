      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 pt-16 sm:pt-20 pb-10 text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          {giftingMoments.map((m) => (
            <span
              key={m}
              className="bg-oatmeal/60 text-muted text-sm px-4 py-1.5 rounded-full font-body border border-linen/40"
            >
              {m}
            </span>
          ))}
          ...
          <section key={box.slug}>
            ...
            >
              ...
              <div>
                ...
                <p className="text-muted text-lg leading-relaxed font-body mb-4">
                  {box.longDescription}
                </p>

                {box.occasions && (
                  <div className="mb-6">
                    <p className="text-sm text-muted-sm mb-2 tracking-wide">
                      Perfect for:
                    </p>
                    <div className="flex flex-wrap gap-2">
                      {box.occasions.map((o) => (
                        <span
                          key={o}
                          className="text-xs bg-oatmeal/50 text-muted px-3 py-1 rounded-full border border-linen/30"
                        >
                          {o}
                        </span>
                      ))}
